class CompetitorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @competitor.save
        format.html { redirect_to @competitor, notice: '公司创建成功' }
  ...
  def update
    respond_to do |format|
      if @competitor.update(competitor_params)
        format.html { redirect_to @competitor, notice: '公司更新成功' }
  ...
  def destroy
    @competitor.destroy
    respond_to do |format|
      format.html { redirect_to competitors_url, notice: '公司删除成功' }
  ...
  private
    ...
    def competitor_params
      params[:competitor][:logo] = params[:competitor][:photo].original_filename
      Competitor.deal_photo(params[:competitor][:photo])
      params.require(:competitor).permit(:name, :alias, :logo)
    end
end
