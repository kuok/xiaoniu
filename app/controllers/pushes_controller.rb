class PushesController < ApplicationController
  ...
  def upload
    return if params[:excel].nil?
    Push.deal_excel(params[:excel])
  end

  def navi_menu
    render :json => NaviMenu.reset_navi_menu_flag
  end
  ...
  private
    ...
    def push_params
      params.require(:push).permit(:p_date, :content, :competitor_id, :type_id)
    end
end
